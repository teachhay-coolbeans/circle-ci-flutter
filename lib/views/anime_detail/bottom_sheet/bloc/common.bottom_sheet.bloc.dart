...
class CommonBottomSheetBloc extends Bloc<CommonBottomSheetEvent, CommonBottomSheetState> {
  ...
  void _getEpisodes(CommonBottomSheetGetEpisodesEvent event, Emitter<CommonBottomSheetState> emit) {}

  void _getMoreEpisodes(CommonBottomSheetGetMoreEpisodesEvent event, Emitter<CommonBottomSheetState> emit) {}
}
