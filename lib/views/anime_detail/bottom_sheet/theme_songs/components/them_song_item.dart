...
class ThemeSongItem extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return ListTile(
      ...
      title: Text(toDisplayText(song.title), maxLines: 1, overflow: TextOverflow.ellipsis),
      subtitle: Text(toDisplayText(song.artist), maxLines: 2, overflow: TextOverflow.ellipsis),
      trailing: Text(toDisplayText(song.between), style: Theme.of(context).textTheme.bodySmall?.copyWith(fontSize: 11), maxLines: 1, overflow: TextOverflow.ellipsis),
    );
  }
}
