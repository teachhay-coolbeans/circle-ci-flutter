...
class ThemeSongDto with _$ThemeSongDto {
  ...
  SongDto toSongDto(int index, String value) {
    ...
    final isContainedEps = cleanedValue.contains("(eps");
    final title = cleanedValue.substring(0, cleanedValue.indexOf("by"));
    final artist = cleanedValue.substring(cleanedValue.indexOf("by") + 3, isContainedEps ? cleanedValue.indexOf("(eps") : null);
    final between = isContainedEps ? cleanedValue.substring(cleanedValue.indexOf("(eps")) : null;
